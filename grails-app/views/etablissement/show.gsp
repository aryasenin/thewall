...
<div class="col-md-6">
    <div class="strong">
        <p><g:message
                code="etablissement.typeFileL.label" default="Type File L"/>:


            <span class="text-weight-normal">${etablissementInstance?.typeFileL}</span>
...
<div class="col-md-6">
    <div class="strong">
        <p><g:message
                code="etablissement.typeFileF.label" default="Type File F"/>:


            <span class="text-weight-normal">${etablissementInstance?.typeFileF}</span>
