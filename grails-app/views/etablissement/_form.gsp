                        ...
                        <div class="separator bottom">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6"><g:textField class="form-control" name="typeFileL"
                                                                       value="${etablissementInstance?.typeFileL}"/></div>
                                </div>
                                <!-- // Group END -->
                            </div>
                            ...
                            <div class="separator bottom">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6"><g:textField class="form-control" name="typeFileF"
                                                                           value="${etablissementInstance?.typeFileF}"/></div>
                                    </div>
                                    <!-- // Group END -->
                                </div>
