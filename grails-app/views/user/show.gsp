...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.userCreated}">
            <li class="fieldcontain">
                <span id="userCreated-label" class="property-label"><g:message code="user.userCreated.label"
                                                                               default="User Created"/></span>

                <span class="property-value" aria-labelledby="userCreated-label"><g:fieldValue bean="${userInstance}"
                                                                                               field="userCreated"/></span>
        ...
        <g:if test="${userInstance?.userUpdated}">
            <li class="fieldcontain">
                <span id="userUpdated-label" class="property-label"><g:message code="user.userUpdated.label"
                                                                               default="User Updated"/></span>

                <span class="property-value" aria-labelledby="userUpdated-label"><g:fieldValue bean="${userInstance}"
                                                                                               field="userUpdated"/></span>
        ...
        <g:if test="${userInstance?.deleted}">
            <li class="fieldcontain">
                <span id="deleted-label" class="property-label"><g:message code="user.deleted.label"
                                                                           default="Deleted"/></span>

                <span class="property-value" aria-labelledby="deleted-label"><g:formatBoolean
                        boolean="${userInstance?.deleted}"/></span>
